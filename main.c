...
/*   Updated: 2024/01/08 20:35:03 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	while (stack_a)
	{
		printf("n- [%d]-p- [%d] -index- [%d] -flag- [%d] -moves- [%d]\n", stack_a->nbr,  stack_a->position, stack_a->index_in_stack, stack_a->flag, stack_a->moves );
		stack_a = stack_a->next;
	}
	printf("\033[32m\n\n\n\n\n\n >>> AFFICHAGe B\n\033[0m");
	while (stack_b)
	{
		printf("n- [%d]-p- [%d] -index- [%d] -flag- [%d] -moves- [%d] -mate- [%d]\n", stack_b->nbr,  stack_b->position, stack_b->index_in_stack, stack_b->flag, stack_b->moves, stack_b->target_node->nbr );
